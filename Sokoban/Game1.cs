...
namespace Sokoban
{
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            font = Content.Load<SpriteFont>("RebootFont"); //Use the name of sprite font file ('File')
            player = Content.Load<Texture2D>("Player");
            dot = Content.Load<Texture2D>("Point");
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            _spriteBatch.DrawString(font, $"Numero de Linhas = {nrLinhas}\nNumero de Colunas = {nrColunas}", new Vector2(10, 10), Color.White);
